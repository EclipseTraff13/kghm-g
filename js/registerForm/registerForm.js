...
function checkValidation(target, itemForm) {
    ...
    switch (validType) {
        ...
        case 'email':
            ...
            element.setAttribute('data-bool', rv_email.test(val))
        ...
        case 'password':
            ...
            check(rv_password.test(val))
            val !== '' && rv_password.test(val) ?
                validInput(element) :
                invalidInput(element, validType)
...
function check(element) {
    ...
    let checkEmail =  element.querySelector('input[type="email"]').dataset.bool
    let checkTel =  element.querySelector('input[type="tel"]').dataset.bool

    if (checkTel === 'true' && checkEmail === 'true') {
...
function validInput(element, name) {
